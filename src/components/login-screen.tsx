  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (isAdminLogin) {
      ...
      if (!username || !password) {
        toast.error("Por favor, insira o nome de usuário e senha de administrador")
        return
      }
      setLoading(true)
      try {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1 text-center animate-[fadeIn_0.5s_ease-in]">
              ...
              <p className="text-[#9d7af7]/70 text-sm">
                {isAdminLogin ? 'Entre com suas credenciais de administrador' : 'Digite seu código de acesso para continuar'}
              </p>
            </div>
            ...
            >
              ...
              <div className="relative flex items-center justify-center gap-3">
                ...
                <span className="text-base font-semibold text-white group-hover:scale-105 transition-transform">
                  {loading ? "Verificando..." : (isAdminLogin ? "Entrar como Admin" : "Iniciar Jornada")}
                </span>
              </div>
            </Button>
            ...
            <div className="text-center">
              <button 
                ...
                className="text-[#9d7af7] hover:text-[#b49af9] transition-colors"
              >
                {isAdminLogin ? 'Login de Usuário' : 'Login de Administrador'}
              </button>
            </div>
          </form>
        </CardContent>
